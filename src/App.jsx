    ...
    return (
      <div className={`flex flex-col space-y-1 ${width}`}>
        ...
        <input
          ...
          className={`rounded-xl border px-4 py-3 text-slate-900 transition-all outline-none ${
            isMissing 
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center py-4 gap-4">
            ...
            <div className="flex items-center gap-4 w-full sm:w-auto">
              ...
              <div className="flex flex-col">
                <h1 className="text-xl sm:text-2xl font-black bg-clip-text text-transparent bg-gradient-to-r from-slate-900 to-slate-700 tracking-tight">Defensoría</h1>
          ...
          <div className="bg-white rounded-3xl flex flex-col p-6 sm:p-10 shadow-sm border border-slate-200 hover:shadow-md transition-shadow gap-8">
            ...
            <div className="flex flex-col space-y-2">
              ...
              <textarea
                ...
                className={`block w-full rounded-2xl border p-5 transition-all outline-none text-slate-900 resize-y leading-relaxed text-base ${
                  missingFields.includes('resumen_hechos') 
                    ? 'border-red-400 focus:border-red-500 focus:ring-4 focus:ring-red-500/20 bg-red-50/50 hover:bg-red-50' 
                    : 'border-slate-300 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/20 bg-slate-50 hover:bg-white'
                }`}
              />
